...
function App() {
  ...
  return (
    <div className="min-h-screen bg-base-200 flex flex-col items-center py-16 px-8 gap-12 font-sans">
        ...
        <div className="flex flex-col items-center w-full gap-12 animate-fade-in max-w-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            <div className="flex flex-col items-center justify-center bg-base-100 p-8 rounded-2xl shadow-xl border-2 border-base-300">
              <span className="text-7xl font-black text-primary mb-2">{projectMetrics.projectLevel}</span>
              <span className="text-xl font-bold text-base-content/70 uppercase tracking-widest">Project Level</span>
            </div>

            <div className="flex flex-col items-center justify-center bg-base-100 p-8 rounded-2xl shadow-xl border-2 border-base-300">
              <span className="text-7xl font-black text-base-content mb-2">{projectMetrics.duplicateScripts}</span>
              <span className="text-xl font-bold text-base-content/70 uppercase tracking-widest text-center">Duplicate Scripts</span>
            </div>
            ...
            <div className="flex flex-col items-center justify-center bg-base-100 p-8 rounded-2xl shadow-xl border-2 border-base-300">
              ...
              <span className="text-xl font-bold text-base-content/70 uppercase tracking-widest">Duplication Ratio</span>
            </div>
          </div>
              ...
              <table className="table table-lg w-full">
                <thead className="bg-base-300 text-base-content text-lg uppercase tracking-wider">
                  <tr>
                    ...
                    <th className="text-center font-bold">Structural<br />Changes</th>
                    <th className="text-center font-bold">Definition<br />Changes</th>
                    <th className="text-center font-bold">Definition<br />Level</th>
                    <th className="text-center font-bold">Feature<br />Guarded</th>
                    <th className="pr-8 text-center font-bold">AST<br />Pipeline</th>
                  </tr>
                </thead>

                <tbody className="bg-base-100">
                  {projectMetrics.blocks.map((block, key) => (
                    <tr key={key} className="hover:bg-base-200 transition-colors border-b border-base-200">
