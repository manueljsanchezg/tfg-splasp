  ...
  return (
    <div className="flex flex-col gap-4 w-full px-4 py-4">
      <div className="flex flex-col justify-between items-center gap-4">
        <h1 className="text-5xl font-black text-base-content">User Management</h1>
        <button
                ...
                {users.map((user) => (
                  ...
                  >
                    <td className="px-4 py-4 text-center">
                      <span className="font-bold text-2xl text-base-content">{user.username}</span>
                    </td>
                    <td className="px-4 py-4 text-center">
      ...
      {!isLoading && users && users.length === 0 && (
        <div className="flex flex-col items-center justify-center h-64 gap-4">
          <p className="text-xl font-semibold text-base-content/60">No users registered yet</p>
          <p className="text-base text-base-content/50">Create a user to get started</p>
        </div>
      )}
    </div>
  )
